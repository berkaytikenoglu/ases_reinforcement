...
class Rewards:
    ...
    # ===== POZİTİF ÖDÜLLER =====
    HIT_REWARD = 100.0              # Tehdidi vurma ödülü
    EPISODE_WIN_BONUS = 500.0       # Tüm tehditleri yok ederse bonus
    AIM_BONUS = 5.0                 # Doğru açıyla ateş etme bonusu
    SURVIVAL_BONUS = 0.5            # Her adımda hayatta kalma bonusu
    
    # ===== NEGATİF CEZALAR =====
    MISS_PENALTY = -15.0            # Atış yapıp ıskalama cezası
    GROUND_HIT_PENALTY = -300.0     # Tehdit yere çarptığında (episode biter)
    WASTED_AMMO_PENALTY = -25.0     # Tehdit yokken ateş etme (gereksiz mermi)
